...
class ChatBody extends StatefulWidget {
  const ChatBody({Key? key, required this.type}) : super(key: key);
  final String type;
...
class _ChatBodyState extends State<ChatBody> {
  ...
  @override
  void dispose() {
    Provider.of<ChatViewModel>(context, listen: false).disp();
    super.dispose();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: boolean
          ? Provider.of<ChatViewModel>(context, listen: false).syncGroupData()
          : null ,
      builder: (context, snapshot) {
        ...
        if ((snapshot.connectionState != ConnectionState.done) && boolean) {
          ...
          return Column(
            children: [
              ChatList(vm: Provider.of<ChatViewModel>(context, listen: true) , groupID: null ),
              const SizedBox(
                height: 8,
              ),
              Row(
  ...
  Widget _buildMessageField(Function onSubmit, AppLocalizations lang) {
    return Stack(children: [
      Provider.of<ChatViewModel>(context, listen: true).audioRecord == null
          ? Container(
          ...
          : Container(),
      Provider.of<ChatViewModel>(context, listen: true).audioRecord == null
          ? Provider.of<ChatViewModel>(context, listen: true).image != null
              ? Row(
                  children: [
                    const SizedBox(
                      width: 16,
